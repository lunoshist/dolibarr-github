...
/**
 *  \file       affaire_note.php
 *  \ingroup    affaire
 *  \brief      Tab for notes on Affaire
 */
...
$langs->loadLangs(array("affaire@affaire", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->affaire->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('Affaire').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-affaire page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Affaire"), -1, $object->picto);
