...
/**
 *  \file       affaire_contact.php
 *  \ingroup    affaire
 *  \brief      Tab for contacts linked to Affaire
 */
...
$title = $langs->trans("Affaire")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-affaire page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Affaire"), -1, $object->picto);
