...
/**
 *  \file       core/modules/affaire/doc/pdf_standard.modules.php
 *  \ingroup    affaire
...
/**
 *	Class to manage PDF template standard_affaire
 */
class pdf_standard_affaire extends ModelePDFAffaire
{
	/**
	 ...
	 *
	 *  @param		Affaire	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Affaire	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('AFFAIRE_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('AFFAIRE_DRAFT_WATERMARK')));
		}
