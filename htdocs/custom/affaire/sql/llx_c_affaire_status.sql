...
-- (9, 'Brouillon (à valider)', 'Brouillon', 1, 3, 00, 0, 'both', 1),
...
-- (21, 'Brouillon (à valider)', 'Brouillon', 1, 5, 00, 0, 'both', 1),
-- (22, 'À préparer', 'À préparer', 1, 5, 100, 0, 'both', 1),
-- (23, 'À expédier', 'À expédier', 1, 5, 100, 0, 'both', 1),
-- (24, 'En cours d expédition', 'Expé. en cours', 1, 5, 200, 0, 'both', 1),
-- (25, 'Annulé', 'Annulé', 1, 5, -1, 0, 'both', 1),
