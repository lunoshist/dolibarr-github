...
ALTER TABLE llx_affaire_affaire ADD INDEX idx_affaire_affaire_fk_project (fk_project);
ALTER TABLE llx_affaire_affaire ADD INDEX idx_affaire_affaire_status (status);
