...
('-1', 'cancel', '(Clôturer) Étape annulé, abandonner ou qui n a pas donné suite (Ex: propal non signé)', '999999', '', 'e7f0f0'),
...
('350', '-closed-', 'Clôturé, achevé de manière relative (Ex: payement partiel)', '212529', 'cad2d2', ''),
