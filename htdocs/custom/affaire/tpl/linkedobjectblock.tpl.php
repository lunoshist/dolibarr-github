...
print "<!-- BEGIN PHP TEMPLATE affaire/affaire/tpl/linkedobjectblock.tpl.php -->\n";
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	print '<td class="linkedcol-element tdoverflowmax100">'.$langs->trans("Affaire");
	if (!empty($showImportButton) && $conf->global->MAIN_ENABLE_IMPORT_LINKED_OBJECT_LINES) {
		$url = dol_buildpath('/affaire/card.php?id='.$objectlink->id);
