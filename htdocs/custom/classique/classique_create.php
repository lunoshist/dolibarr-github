...
if (empty($reshook)) {
	...
	/* TODO add parameters (of affaire module) to skip affaire fields complétions
	if ($action == 'create' && getDolGlobalInt('SKIP_AFFAIRE_FIELD_ON_CLASSIQUE_CREATION')) {
		$ref = $object->getNextValue() ?? 'WAAHH';
		$action = 'add';
	}
	*/
